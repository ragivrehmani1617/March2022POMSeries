...
//	}
	...
	public void productInfoDescriptionTest() {
		...
		productInfoPage = searchResPage.selectProduct("MacBook Pro");
		softAssert
				.assertTrue(productInfoPage.getProductInfoPageInnerText().contains("Latest Intel mobile architecture"));
		softAssert.assertTrue(
				productInfoPage.getProductInfoPageInnerText().contains("new Core 2 Duo MacBook Pro is over 50%"));
